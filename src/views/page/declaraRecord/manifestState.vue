    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="单号">
                                <el-input v-model="ruleForm.masterBlNo" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"  > 
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column prop="masterBlNo" label="单号" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
            <el-table-column prop="resultStatus" label="查询结果" :show-overflow-tooltip="true" align="left" min-width="80"> 
                <template slot-scope="scope">
                    <span v-if="scope.row.resultStatus==0" size="mini" align="left">请求失败</span>
                    <span v-if="scope.row.resultStatus==1" size="mini" align="left">有数据</span>
                    <span v-if="scope.row.resultStatus==2" size="mini" align="left">无数据</span>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="createTime" label="查询时间" :show-overflow-tooltip="true" align="left" width="142"></el-table-column>
                <template slot="empty">
                    <noData></noData>
                </template>
          </el-table>
        ...
        methods: {
            ...
            searchList(abnormal){
                ...
                let query = {
                    ...
                    origin: this.ruleForm.origin, //来源
                    companyName: this.ruleForm.companyName, //公司
                    masterBlNo: this.ruleForm.masterBlNo, //单号
                    startDate: this.ruleForm.startTime, //开始时间
                    endDate: this.ruleForm.endTime, //结束时间
                    resultStatus: this.ruleForm.resultStatus //查询结果
                }
                this.$axios.post(this.commonJs.localUrl +`/schedules/declare/getManifestStateRecordList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
