    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="主单号">
                                <el-input v-model="ruleForm.mblno" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"> 
                            <el-form-item label="副单号">
                                <el-input v-model="ruleForm.hblno" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column prop="mblno" label="主单号" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
            <el-table-column prop="hblno" label="副单号" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
            <el-table-column prop="resultStatus" label="查询结果" :show-overflow-tooltip="true" align="left" min-width="80"> 
                <template slot-scope="scope">
                    ...
                    <span v-if="scope.row.resultStatus==500" size="mini" align="left">请求失败</span>
                    <span v-if="scope.row.resultStatus==501" size="mini" align="left">用户使用错误</span>
                </template>
            </el-table-column>
            <el-table-column prop="sourceData" label="来源" :show-overflow-tooltip="true" align="left" min-width="50"> 
                <template slot-scope="scope">
        ...
        methods: {
            ...
            handleExportClick(){
                ...
                let query = {
                    ...
                    mblno: this.ruleForm.mblno, //主单号
                    hblno: this.ruleForm.hblno, //副单号
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/declare/exportLuJiDeclareListExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/declare/getShippingBillRecordList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
