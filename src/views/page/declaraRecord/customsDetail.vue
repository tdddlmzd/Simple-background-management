    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="报关单号">
                                <el-input v-model="ruleForm.declNo" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%">
                            <el-form-item label="经营码">
                                <el-input v-model="ruleForm.tradeCode" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column prop="declNo" label="报关单号" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
            <el-table-column prop="tradeCode" label="经营码" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
        ...
        methods: {
            ...
            handleExportClick(){
                ...
                let query = {
                    ...
                    declNo: this.ruleForm.declNo, //报关单号
                    tradeCode: this.ruleForm.tradeCode, //经营码
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/declare/exportLuJiClearanceOfGoodsExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/declare/queryLuJiClearanceOfGoodsList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
