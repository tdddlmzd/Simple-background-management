        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column prop="type" label="查询类型" :show-overflow-tooltip="true" align="left" min-width="70">
                <template slot-scope="scope">
                    <span v-if="scope.row.type==1" size="mini" align="left">提单号</span>
                    <span v-if="scope.row.type==2" size="mini" align="left">报关号</span>
                </template>
            </el-table-column>
            <el-table-column prop="keywords" label="单号" :show-overflow-tooltip="true" align="left" min-width="140"> </el-table-column>
            <el-table-column prop="ieid" label="进/出口" align="left" min-width="70"> 
                <template slot-scope="scope">
                    <span v-if="scope.row.ieid=='I'" >进口</span>
                    <span v-if="scope.row.ieid=='E'" >出口</span>
                </template>
            </el-table-column>
        ...
        methods: {
            ...
            handleExportClick(){
                ...
                let query = {
                    ...
                    ieid: this.ruleForm.ieid,
                    type: this.ruleForm.queryType,
                    resultStatus: this.ruleForm.isHaveData,
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/declare/getDeclareList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
