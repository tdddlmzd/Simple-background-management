                ...
                <ul class="routeUl">
                    <li class="routeLi">
                        <el-row>
                            ...
                            <el-col style="width:33%">
                                <el-form-item label="IMO" prop="imo" :rules="[{ required: true, message: '请输入IMO', trigger: 'blur'}]">
                            ...
                            <el-col style="width:33%">
                                <el-form-item label="MMSI" prop="mmsi" :rules="[{ required: true, message: '请输入MMSI', trigger: 'blur'}]">
                        ...
                        <el-row>
                            <el-col style="width:33%">
                                <el-form-item label="船名(英文)" prop="nameEn" :rules="[{ required: true, message: '请输入船名(英文)', trigger: 'blur'}]">
