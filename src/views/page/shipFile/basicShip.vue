    ...
    <div class="basicPortContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column prop="shipOwnerCn" label="运营方" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="140">
...
<script>
    import basicShipAdd from "./basicShipAdd.vue";
