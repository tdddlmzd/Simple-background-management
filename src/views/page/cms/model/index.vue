    ...
    <div class="basicPortContent">
        ...
        <div class="tablePage">
            ...
            <el-table
                ...
                <el-table-column prop="modelName" label="模型名" align="left" show-overflow-tooltip/>

                <el-table-column prop="componentName" label="组件名" align="left" show-overflow-tooltip width="300"/>
                ...
                <el-table-column align="left" width="80" label="操作" v-if="getCookie('userName') === 'chenxiwang'">
                    <el-link type="danger" :underline="false" @click="remove(row)" slot-scope="{row}">删除</el-link>
                </el-table-column>
            ...
            <el-dialog
                ...
                :show-close="false">
                <model-add :model-id="current.id" @close="closeDialog"/>
            </el-dialog>
...
import ModelAdd from "@/views/page/cms/model/ModelAdd";
import {confirm} from "@/views/page/cms/utils";
...
export default {
    ...
    methods: {
        ...
        list() {
            this.isLoading = true;
            return this.$http.get('/schedules/cms/listModel').then(res => {
        ...
        remove(row) {
            this.$confirm2('确定删除?').then(() => {
                this.isLoading = true;
                return this.$http.get('/schedules/cms/removeModel/' + row.id, this.page).then(res => {
