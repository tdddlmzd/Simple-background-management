    ...
    <div class="basicPortContent" ref="basicPortContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="码头代码">
                                <el-input v-model="ruleForm.terminalcd" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%" >
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="terminalcd"  label="码头代码"  :show-overflow-tooltip=true align="left" min-width="80"> 

                </el-table-column>
                <el-table-column  prop="carriercd"  label="船公司代码"  :show-overflow-tooltip=true align="left" min-width="80"> 

                </el-table-column>
                <el-table-column  prop="referenceno"  label="单号"  :show-overflow-tooltip=true align="left" min-width="140"> 
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                let query = {
                    ...
                    referenceno:  this.ruleForm.referenceno, //单号
                    ctnrno: this.ruleForm.ctnrno, //箱号
                    terminalcd: this.ruleForm.terminalcd,//码头代码
                    carriercd: this.ruleForm.carriercd,//船公司代码
                    resultStatus: this.ruleForm.resultStatus, //查询结果
                    startTime: this.ruleForm.startTime, //开始时间
                    endTime: this.ruleForm.endTime//结束时间
                }
                this.$axios.post(this.commonJs.localUrl +`/schedules/usa/queryUsaTerminalList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query
                ,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/usa/exportUsaTerminalExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
        ...
        mounted(){
            ...
            this.$bus.on('clickMenu', content => {
                ...
                this.ruleForm.referenceno = "", //单号
                this.ruleForm.ctnrno ="", //箱号
                this.ruleForm.terminalcd ="", //码头代码
                this.ruleForm.carriercd ="", //船公司代码
