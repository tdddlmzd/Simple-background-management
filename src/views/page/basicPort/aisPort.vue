    ...
    <div class="basicPortContent" ref="basicPortContent">
        ...
        >
            <div class="searhContent">
                ...
                <span class="source">数据来源：龙船</span>
            </div>
            <div class="tablePage">
                <el-table 
                    :data="tableData" 
                ...
                >
                    ...
                    <el-table-column prop="portCode" label="五字码" align="left" :show-overflow-tooltip=true min-width="100" :sortable="sortableState" :filters="[]">
                        
                    </el-table-column>
                    <el-table-column prop="country" label="国家" align="left" :show-overflow-tooltip=true min-width="100" :sortable="sortableState" :filters="[]">
                        
                    </el-table-column>
                    <el-table-column prop="baseCode" label="标准五字码" align="left" :show-overflow-tooltip=true min-width="140" :sortable="sortableState" :filters="[]">
                        <template slot-scope="scope">
                            <div class="sel-el">
                                <el-select 
        ...
        <!--分页-->
        <ThePagination ref="refPagination" :pageNumber="pageNumber" :attribute="paginationAttribute" class="refPagination" v-if="isAsiShow"></ThePagination>
    </div>
</template>
        ...
        methods : {
            ...
            handleInputClick(value){
                ...
                setTimeout(() => {
                    ...
                    this.$axios.get(this.commonJs.localUrl + `/schedules/aisPort/list?pageNumber=${this.page.pageNo
            ...
            saveList(item){
                ...
                this.$axios.post(this.commonJs.localUrl + `/schedules/aisPort/update`,
                    saveObj,
                    {
                        headers : {
                            Authorization: `Bearer ${this.getAuthorization()}`,
