    ...
    <div class="basicPortContent" ref="basicPortContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="车牌号">
                                <el-input v-model="ruleForm.vclN" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"  > 
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="userName" label="用户名"  :show-overflow-tooltip=true align="left" min-width="80"></el-table-column>
                <el-table-column  prop="companyName"  label="公司"  :show-overflow-tooltip=true align="left" min-width="80"></el-table-column>
                <el-table-column  prop="vclN"  label="车牌号"  :show-overflow-tooltip=true align="left" min-width="120"></el-table-column>
                <el-table-column  prop="qryBtm"  label="开始时间" :show-overflow-tooltip=true align="left" min-width="142">
                </el-table-column>
                <el-table-column  prop="qryEtm"  label="结束时间" :show-overflow-tooltip=true align="left" min-width="142">
                </el-table-column>
                <el-table-column  prop="resultStatus" label="查询结果" :show-overflow-tooltip=true align="left" min-width="80"> 
                    <template slot-scope="scope">
                        <span>{{scope.row.resultStatus == 0 ? "有数据" : scope.row.resultStatus == 1000 ? "无数据" : ""}}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column  prop="searchTime"  label="查询时间" :show-overflow-tooltip=true align="left" min-width="110"></el-table-column>
                <template slot="empty">
                    <noData></noData>
                </template>
            </el-table>
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/truckEs/getTruckEsList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query
                ,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/truckEs/exportTruckEsExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
