    ...
    <div class="basicPortContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column prop="terminalCn" label="码头中文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
                
                </el-table-column>
                <el-table-column prop="terminal" label="码头英文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
...
<script>
    import dockManageAdd from "./dockManageAdd.vue";
