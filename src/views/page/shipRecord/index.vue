    ...
    <div class="basicPortContent" ref="basicPortContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="船名">
                                <el-input v-model="ruleForm.vesselName" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="进口航次">
                                <el-input v-model="ruleForm.voyin" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"> 
                            <el-form-item label="出口航次">
                                <el-input v-model="ruleForm.voyout" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"  > 
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="polcd"  label="起运港"  :show-overflow-tooltip=true align="left" min-width="100"> 

                </el-table-column>
                <el-table-column  prop="vesselName"  label="船名"  :show-overflow-tooltip=true align="left" min-width="120"> 

                </el-table-column>
                <el-table-column  prop="voyin"  label="进口航次"  :show-overflow-tooltip=true align="left" min-width="70"> 

                </el-table-column>
                <el-table-column  prop="voyout"  label="出口航次"  :show-overflow-tooltip=true align="left" min-width="70"> 

                </el-table-column>
                <el-table-column  prop="resultStatus" label="查询结果" :show-overflow-tooltip=true align="left" min-width="80"> 
                    <template slot-scope="scope">
                        <span>{{scope.row.resultStatus == 1 ? "有数据" : scope.row.resultStatus == 1000 ? "无数据" : ""}}</span>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                let query = {
                    ...
                    polcd: this.ruleForm.polcd,
                    vesselName: this.ruleForm.vesselName,
                    voyin: this.ruleForm.voyin,
                    voyout: this.ruleForm.voyout,
                    resultStatus: this.ruleForm.resultStatus,
                    origin: this.ruleForm.origin,
                    startTime: this.ruleForm.startTime,
                    endTime: this.ruleForm.endTime
                }
                this.$axios.post(this.commonJs.localUrl +`/schedules/plan/getHistoryList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query
                ,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/plan/exportRecordExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
        ...
        mounted(){
            ...
            this.$bus.on('clickMenu', content => {
                ...
                this.ruleForm.polcd = "",//查询类型
                this.ruleForm.vesselName = "", //船名，
                this.ruleForm.voyin ="",
                this.ruleForm.voyout ="",
