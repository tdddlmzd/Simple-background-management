    ...
    <div class="basicPortContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column prop="areaCn" label="大航线中文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
                
                </el-table-column>
                <el-table-column prop="areaEn" label="大航线英文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
                
                </el-table-column>
                <el-table-column prop="webSort" label="展示顺序" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
...
<script>
    import bigLineManage from "./bigLineManage.vue";
        ...
        methods: {
            ...
            handleInputClick(value) {
                  ...
                  setTimeout(() => {
                    ...
                    this.$axios.get(this.commonJs.localUrl + `/schedules/area/list?pageNumber=${this.page.pageNo
                            ...
                            if(res.data.status == 1){
                                ...
                                for(let i=0; i<this.tableData.length; i++){
                                    if(this.tableData[i].webSort){
                                        this.tableData[i].webSort = this.tableData[i].webSort - 0
                                    }
                                }
            ...
            searchList(newOrAdd){
                ...
                this.$axios.get(this.commonJs.localUrl + `/schedules/area/list?pageNumber=${this.page.pageNo
                    ...
                    }&search=${this.ruleForm.searchStr
                    }`,{
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token")
