        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column  prop="type" label="查询类型"  :show-overflow-tooltip=true align="left" min-width="70">
                <template slot-scope="scope">
                    <span v-if="scope.row.type==1"  size="mini" align="left">订阅</span>
                    <span v-if="scope.row.type==2"  size="mini" align="left">下载</span>
                </template>
            </el-table-column>
            <el-table-column  prop="blno" label="提单号"  :show-overflow-tooltip=true align="left" min-width="140"> </el-table-column>
            <el-table-column  prop="carrier" label="持箱人"  :show-overflow-tooltip=true align="left" min-width="100"> </el-table-column>
            ...
            <el-table-column  prop="port" label="港口"  :show-overflow-tooltip=true align="left" min-width="140"> </el-table-column>
            <el-table-column  prop="status" label="查询结果" :show-overflow-tooltip=true align="left" min-width="80"> 
                <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/eir/getEirDetailList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/declare/exportRecordExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
