    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%">
                            <el-form-item label="箱号">
                                <el-input v-model="ruleForm.containerNo" placeholder="请输入" clearable></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column  prop="billNo" label="提单号"  :show-overflow-tooltip=true align="left" min-width="140"> </el-table-column>
            <el-table-column  prop="containerNo" label="箱号"  :show-overflow-tooltip=true align="left" min-width="140"> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/trace/getTerminalDataRecordList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
