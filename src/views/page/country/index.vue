    ...
    <div class="basicPortContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column prop="countryCn" label="国家中文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
                
                </el-table-column>
                <el-table-column prop="countryEn" label="国家英文名" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="110">
                
                </el-table-column>
                <el-table-column prop="countryCode" label="国家简码" align="left" :show-overflow-tooltip="true" :sortable="sortableState" :filters="[]" min-width="130">
...
<script>
    import countryManageAdd from "./countryManageAdd.vue";
        ...
        methods: {
            ...
            handleInputClick(value) {
                  ...
                  setTimeout(() => {
                    ...
                    this.$axios.get(this.commonJs.localUrl + `/schedules/country/query?searchStr=${value
            ...
            searchList(newOrAdd){
                ...
                this.$axios.get(this.commonJs.localUrl + `/schedules/country/query?searchStr=${this.ruleForm.searchStr
                    }&pageNumber=${this.page.pageNo
                    }&pageSize=${this.page.pageSize
                    }`,{
                        headers: {
