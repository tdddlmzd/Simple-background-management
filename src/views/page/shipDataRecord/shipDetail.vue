    ...
    <div class="portContent" ref="portContent">
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column  prop="mmsi" label="MMSI"  :show-overflow-tooltip=true align="left" min-width="140"> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/vesselEs/exportVesselDetailExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
            ...
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/vesselEs/getVesselDetailList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query,{
                    headers: {
                        Authorization: `Bearer ${this.getAuthorization()}`,
                        AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
                    }
