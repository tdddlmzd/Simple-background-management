    ...
    <div class="portContent" ref="portContent">
        ...
        <div class="tablePage">
          ...
          >
            ...
            <el-table-column  prop="commitTime"  label="查询时间"  :formatter="formatDate" :show-overflow-tooltip=true align="left" width="142"></el-table-column>
            <!-- <el-table-column  prop="updateTime"  label="操作时间"  :formatter="formatDate"  :show-overflow-tooltip=true align="left" width="142"></el-table-column> -->
                <template slot="empty">
                    <noData></noData>
                </template>
          </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleStatus(row){
                this.$confirm(this.commonJs.confirm_normal, "", {
