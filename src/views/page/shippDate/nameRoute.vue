    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="船名">
                                <el-input v-model="ruleForm.vessel" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"> 
                            <el-form-item label="航次">
                                <el-input v-model="ruleForm.voyage" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col style="width:22%"> 
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="params"  label="航线代码"  :show-overflow-tooltip=true align="left" min-width="140"> 
                    <template slot-scope="scope">
                        <span>{{scope.row.params.routeCode}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="范围"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.weekOut}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="船名"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.vessel}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="航次"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.voyage}}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column  prop="params" label="起始港"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.polCode}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="目的港"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.podCode}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="页码"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.pageNumber}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="params" label="显示数量"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.get(this.commonJs.localUrl + `/schedules/operLog/getScheduleRecordList?searchUrl=serviceSchedule&pageNumber=${this.page.pageNo
                ...
                }&vessel=${this.ruleForm.vessel
                }&voyage=${this.ruleForm.voyage
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'GET',url: this.commonJs.localUrl +`/schedules/record/exportServiceSchedule?total=${this.$refs.refPagination.page.total}&userName=${this.ruleForm.userName
                }&companyName=${this.ruleForm.companyName
                }&carriercd=${this.ruleForm.carriercd
                }&routeCode=${this.ruleForm.routeCode
                }&polCode=${this.ruleForm.polCode
