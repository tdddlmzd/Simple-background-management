    ...
    <div class="portContent" ref="portContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="params"  label="船名"  :show-overflow-tooltip=true align="left" min-width="140"> 
                    <template slot-scope="scope">
                ...
                <el-table-column  prop="params" label="离港日期"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                ...
                <el-table-column  prop="pageNumber" label="页码"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.pageNumber}}</span>
                    </template>
                </el-table-column>
                <el-table-column  prop="pageSize" label="显示数量"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                if(this.ruleForm.etd == '' || this.ruleForm.etd == null){
                    this.ruleForm.etd = ''
                }
                this.$axios.get(this.commonJs.localUrl +`/schedules/operLog/getScheduleRecordList?searchUrl=vesselSchedule&pageNumber=${this.page.pageNo
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'GET',url: this.commonJs.localUrl +`/schedules/record/exportVesselSchedule?total=${this.$refs.refPagination.page.total}&userName=${this.ruleForm.userName
                }&companyName=${this.ruleForm.companyName
                }&carriercd=${this.ruleForm.carriercd
                }&etd=${this.ruleForm.etd ? this.ruleForm.etd : ''
                }&eta=${this.ruleForm.eta ? this.ruleForm.eta : ''
