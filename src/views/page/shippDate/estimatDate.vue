    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.get(this.commonJs.localUrl +`/schedules/operLog/getScheduleRecordList?searchUrl=routeEstimate&pageNumber=${this.page.pageNo
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'GET',url: this.commonJs.localUrl +`/schedules/record/exportRouteEstimate?total=${this.$refs.refPagination.page.total}&userName=${this.ruleForm.userName
                    }&companyName=${this.ruleForm.companyName
                    }&carriercd=${this.ruleForm.carriercd
                    }&routeCode=${this.ruleForm.routeCode
                    }&vessel=${this.ruleForm.vessel
