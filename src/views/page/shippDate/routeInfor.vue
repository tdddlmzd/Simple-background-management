    ...
    <div class="portContent" ref="portContent">
                    ...
                    <el-row>
                        ...
                        <el-col style="width:22%"> 
                            <el-form-item label="航线">
                                <el-input v-model="ruleForm.service" clearable style="width:100%" placeholder="请输入" ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="params" label="航线"  :show-overflow-tooltip=true align="left" min-width="90">
                    <template slot-scope="scope">
                        <span>{{scope.row.params.service}}</span>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.get(this.commonJs.localUrl + `/schedules/operLog/getScheduleRecordList?searchUrl=staticSchedule&pageNumber=${this.page.pageNo
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'GET',url: this.commonJs.localUrl +`/schedules/record/exportStaticSchedule?total=${this.$refs.refPagination.page.total}&userName=${this.ruleForm.userName
                }&companyName=${this.ruleForm.companyName
                }&carriercd=${this.ruleForm.carriercd
                }&routeCode=${this.ruleForm.routeCode
                }&service=${this.ruleForm.service
