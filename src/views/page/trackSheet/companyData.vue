    ...
    <div class="portContent" ref="portContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="carriercd"  label="船公司"  :show-overflow-tooltip=true align="left" min-width="100"> 
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/trace/getCarrierRecordList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query
                ,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/trace/exportCarrierExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
