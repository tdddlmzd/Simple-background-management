    ...
    <div class="portContent" ref="portContent">
        ...
        <div class="tablePage">
            ...
            >
                ...
                <el-table-column  prop="polcd"  label="起始港"  :show-overflow-tooltip=true align="left" min-width="100"> 

                </el-table-column>
                <el-table-column  prop="vesselName"  label="船名"  :show-overflow-tooltip=true align="left" min-width="120"> 

                </el-table-column>
                <el-table-column  prop="voyage"  label="航次"  :show-overflow-tooltip=true align="left" min-width="70"> 
    ...
    export default {
        ...
        methods: {
            searchList(abnormal){
                ...
                this.$axios.post(this.commonJs.localUrl +`/schedules/plan/getNewPlanRecordList?pageNumber=${this.page.pageNo}&pageSize=${this.page.pageSize}`, query
                ,{
                    headers: {
            ...
            handleExportClick(){
                ...
                this.$axios({method: 'POST',url: this.commonJs.localUrl +`/schedules/plan/exportPlanExcel?total=${this.$refs.refPagination.page.total}`,data:query,
                    responseType: 'blob',
                        headers: {
                            Authorization: `Bearer ${this.getAuthorization()}`,
                            AccessToken: this.getCookie("token").replace("Bearer","Jwt"),
